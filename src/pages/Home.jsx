...
const grupos = [
  ...
  },
  {
    ...
    roles: [
      ...
      { label: 'Panel Camarero', path: '/camarero', emoji: '🧑‍🍳', color: '#f59e0b', desc: 'Mapa de sala y cobros' },
    ],
  },
  {
    titulo: 'Producción',
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '3.5rem 1.5rem 3rem' }}>
      <div className="anim-fade" style={{ width: '100%', maxWidth: '980px' }}>
        ...
        <p style={{ marginTop: '2.75rem', fontSize: '0.75rem', color: 'var(--color-faint)', textAlign: 'center' }}>v0.7.0 · Demo en desarrollo</p>
      </div>
    </div>
  )
}
