...
**Estado: v0.123.0 · 996 tests JS + 37 pruebas de SQL en verde · CI y deploy en
...
### Lo último — veinticuatro releases, del 26 de agosto al 9 de septiembre
...
2. **Del repaso del panel de Admin (31/08)**, lo que quedó sin hacer. Los
   ...
   - ~~Mesas: no se pueden renumerar ni reordenar…~~ ✅ **hecho el 08/09**
...
```bash
npm test                           # 996 tests, 10 pantallas cubiertas
...
- **Informes** calculados en el servidor por rango de fechas (los cinco de
  siempre **o el que se escriba**), comparados con el periodo anterior, con CSV
...
- **996 tests JS** (las **diez** pantallas cubiertas) **+ 37 pruebas de SQL**
